...
public class Trilateration
{
	...
	static double calcDistance(double rssi)
	{
		...
		// 104.09004338 + 13.26842562x + 0.57250833x^2 + 0.00986120x^3 +
		// 0.00006099x^4

		// SI NORTH THIRD FLOOR (room 3250)
		// double distance = 104.09004338 + 13.26842562 * rssi + 0.57250833*
		// Math.pow(rssi,2)
		// + 0.00986120*Math.pow(rssi, 3) + 0.00006099 * Math.pow(rssi,4);

		// SI NORTH FIRST FLOOR
		// 0 degree
		// double distance = 3324.4981666 + 234.0366524 * rssi + 6.0593624*
		// Math.pow(rssi,2)
	...
	static double calDistToDeg(double dist)
	{
		...
		// result =
		// Math.cos(ang)*Math.sqrt((Math.pow(a,4)*(Math.pow(Math.cos(ang),2))
			...
			double rssi3)
	{
		...
		MyLong = (2 * (Lat3 - Lat1) * (Math.pow(dist2, 2) - Math.pow(dist1, 2)) - 2
				* (Lat2 - Lat1) * (Math.pow(dist3, 2) - Math.pow(dist1, 2)))
				/ (4 * (Lat2 - Lat1) * (Long3 - Long1) - 4 * (Lat3 - Lat1)
						* (Long2 - Long1));
			...
			double rssi3)
	{
		...
		MyLat = (2 * (Long2 - Long1)
				* (Math.pow(dist3, 2) - Math.pow(dist1, 2)) - 2
				* (Long3 - Long1) * (Math.pow(dist2, 2) - Math.pow(dist1, 2)))
				/ (4 * ((Lat2 - Lat1) * (Long3 - Long1) - (Lat3 - Lat1)
						* (Long2 - Long1)));
	...
	static double[] myRotation(double x, double y, double dist, double deg)
	{
		...
		tmpX = x * Math.cos((Math.PI / 180) * deg) - y
				* Math.sin((Math.PI / 180) * deg);
		tmpY = x * Math.sin((Math.PI / 180) * deg) + y
				* Math.cos((Math.PI / 180) * deg);
			...
			double rssi3)
	{
		...
		// Math.pow(tmpSlide,2) - Math.pow(tmpLong2, 2)) / (2*tmpLat2*tmpSlide))
		// );
		deg = (180 / Math.PI)
				* Math.acos(Math.abs(tmpLat2) / Math.abs(tmpSlide));
		...
		MyLat = (Math.pow(tmpWAP1[2], 2) - Math.pow(tmpWAP2[2], 2) + Math.pow(
				tmpWAP2[0], 2)) / (2 * tmpWAP2[0]);

		MyLong = (Math.pow(tmpWAP1[2], 2) - Math.pow(tmpWAP3[2], 2)
				- Math.pow(MyLat, 2) + Math.pow(MyLat - tmpWAP3[0], 2) + Math
					.pow(tmpWAP3[1], 2)) / (2 * tmpWAP3[1]);
